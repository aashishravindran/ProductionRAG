...
_CATEGORY_EXEMPLARS: dict[str, list[str]] = {
    ...
    "research": [
        "What percentage of companies successfully deploy GenAI?",
        "What does the industry report say about AI adoption rates?",
        "What are the statistics on enterprise AI investment and ROI?",
        "What is the pilot-to-production chasm for AI tools?",
        "How do external AI partnerships compare to internal builds?",
        "What is the shadow AI economy and how widespread is it?",
        "What workforce changes does the GenAI report predict?",
        "What are the winning strategies for AI adoption according to the study?",
        "How long before enterprises lock in GenAI vendor relationships?",
        "What is the narrowing window for crossing the GenAI divide?",
    ],
}
